...
#define CSDADC_IN_PORT GPIO_PRT9
#define CSDADC_IN_PORT_NUM 9U
#define CSDADC_IN_PIN 1U
#define CSDADC_IN_NUM 1U
...
#endif
#define CSDADC_IN_HSIOM ioss_0_port_9_pin_1_HSIOM
#define CSDADC_IN_IRQ ioss_interrupts_gpio_9_IRQn
#if defined (CY_USING_HAL)
	#define CSDADC_IN_HAL_PORT_PIN P9_1
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CSDADC_IN P9_1
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)

...
#endif //defined (CY_USING_HAL)
const cy_stc_gpio_pin_config_t CSDADC_IN_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_ANALOG,
	.hsiom = CSDADC_IN_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL)
	const cyhal_resource_inst_t CSDADC_IN_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = CSDADC_IN_PORT_NUM,
		.channel_num = CSDADC_IN_PIN,
	};
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&CSDADC_IN_obj);
#endif //defined (CY_USING_HAL)
